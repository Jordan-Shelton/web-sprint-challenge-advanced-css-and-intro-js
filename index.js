...
function getArtistByIndex(array, index, name) {
...
function addArtist(array){
    array.push({
      id: 20,
      name: 'Jordan Shelton', 
      years: '1995 - still kicking',
      genre: 'Web Design', 
      nationality: 'American',
      bio: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolore recusandae error sit, optio eligendi necessitatibus nam ipsa eius soluta natus, nisi reprehenderit quis! Omnis ad sunt reiciendis non illum expedita.'
    })
    return artists;
  }
...
function lotsOfArt(array, num, name){
  let newestArray = [];
  for(let i = 0; i < array.length; i++){
    if(num > 100){
      newestArray.shift(name);
    }
  }return newestArray;
}
